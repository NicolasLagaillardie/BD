...
matplot(data[,5],type='l',lwd=2,ylim=c(0,1))
...
nbasis <- 101
basis <- create.fourier.basis(rangeval=c(0,1189), nbasis= nbasis) 
fdobj <- smooth.basis(hoursOfDay, data$V1, SplineFourier)$fd
matplot(fdobj,type='l',lwd=2,ylim=c(0,1))
lines(???)
